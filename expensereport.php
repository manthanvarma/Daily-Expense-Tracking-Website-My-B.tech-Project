		...
		<div class = "page-wrapper">
			...
			<div class="row">
				<div class="col-md-12 grid-margin stretch-card">
					<div class="card">
						<div class="card-body">
							<h6 class="card-title">Expense Report</h6>
					...
					<?php } ?>
								<form class="forms-sample" action="expense_report.php" method="POST">
								<div class = "row">
									<div class = "col-sm-4">
										<div class = "mb-3">
									...
									<div class = "col-sm-4">
										<div class = "mb-3">
											<div class = "mt-1 mb-1">Category: </div>
											<select class = "form-select" id = "category_name" name="category_name" />
												<option selected value = "none" required>Select your category</option>
												<?php 
