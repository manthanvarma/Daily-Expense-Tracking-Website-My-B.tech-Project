...
if ($total_pages > 1) {
    $pagination = paginate ('manage_category.php?' . $url_string, $cur_page, $total_pages);
    $url_string .= "&page=" . $cur_page;
}

$sql ="SELECT * FROM category WHERE id = :id OR id = 0 limit $page_start , $per_page  ";
										...
										<table class="table">
											...
											<tbody>
												<tr>
													...
													<td><a href="edit_category.php?category_id=<?php echo "$category_id"; ?>"><div class="btn btn-outline-primary"><i class="ms-2  me-2 icon-md" data-feather="edit"></i></div></a></td>
													<td><a href="delete_category.php?category_id=<?php echo "$category_id"; ?>" onclick="return confirm('Are you sure?')"><div class="btn btn-outline-Danger"><i class="ms-2  me-2 icon-md" data-feather="trash"></i></div></a></td>
												</tr>
											<?php }} $conn = null;?>
											</tbody>
										</table>
